...
{
    protected $table            = 'line6_data_apb1';
    ...
    public function getDistinctTempLeftActual()
    {
        ...
        WHERE L6_APB1_TEMP_LEFT_ACTUAL >= 10 AND L6_APB1_TEMP_LEFT_ACTUAL < 21
        ...
        FROM line6_data_apb1
        WHERE L6_APB1_TEMP_LEFT_ACTUAL >= 21 AND L6_APB1_TEMP_LEFT_ACTUAL < 31
        AND waktu BETWEEN '$startTime' AND '$endTime'
        ...
        FROM line6_data_apb1
        WHERE L6_APB1_TEMP_LEFT_ACTUAL >= 31 AND L6_APB1_TEMP_LEFT_ACTUAL < 41
        AND waktu BETWEEN '$startTime' AND '$endTime'
        ...
        FROM line6_data_apb1
        WHERE L6_APB1_TEMP_LEFT_ACTUAL >= 41 AND L6_APB1_TEMP_LEFT_ACTUAL < 51
        AND waktu BETWEEN '$startTime' AND '$endTime'
        ...
        FROM line6_data_apb1
        WHERE L6_APB1_TEMP_LEFT_ACTUAL >= 51 AND L6_APB1_TEMP_LEFT_ACTUAL < 61
        AND waktu BETWEEN '$startTime' AND '$endTime'
        ...
        FROM line6_data_apb1
        WHERE L6_APB1_TEMP_LEFT_ACTUAL >= 61 AND L6_APB1_TEMP_LEFT_ACTUAL < 71
        AND waktu BETWEEN '$startTime' AND '$endTime'
        ...
        FROM line6_data_apb1
        WHERE L6_APB1_TEMP_LEFT_ACTUAL >= 71 AND L6_APB1_TEMP_LEFT_ACTUAL < 81
        AND waktu BETWEEN '$startTime' AND '$endTime'
        ...
        FROM line6_data_apb1
        WHERE L6_APB1_TEMP_LEFT_ACTUAL >= 81 AND L6_APB1_TEMP_LEFT_ACTUAL < 91
        AND waktu BETWEEN '$startTime' AND '$endTime'
    ...
    public function getDistinctTempRightActual()
    {
        ...
        FROM line6_data_apb1
        WHERE L6_APB1_TEMP_RIGHT_ACTUAL >= 10 AND L6_APB1_TEMP_RIGHT_ACTUAL < 21
        AND waktu BETWEEN '$startTime' AND '$endTime'
        ...
        SELECT '21-30.9', COUNT(*)
        FROM line6_data_apb1
        WHERE L6_APB1_TEMP_RIGHT_ACTUAL >= 21 AND L6_APB1_TEMP_RIGHT_ACTUAL < 31
        AND waktu BETWEEN '$startTime' AND '$endTime'
        ...
        SELECT '31-40.9', COUNT(*)
        FROM line6_data_apb1
        WHERE L6_APB1_TEMP_RIGHT_ACTUAL >= 31 AND L6_APB1_TEMP_RIGHT_ACTUAL < 41
        AND waktu BETWEEN '$startTime' AND '$endTime'
        ...
        SELECT '41-50.9', COUNT(*)
        FROM line6_data_apb1
        WHERE L6_APB1_TEMP_RIGHT_ACTUAL >= 41 AND L6_APB1_TEMP_RIGHT_ACTUAL < 51
        AND waktu BETWEEN '$startTime' AND '$endTime'
        ...
        SELECT '51-60.9', COUNT(*)
        FROM line6_data_apb1
        WHERE L6_APB1_TEMP_RIGHT_ACTUAL >= 51 AND L6_APB1_TEMP_RIGHT_ACTUAL < 61
        AND waktu BETWEEN '$startTime' AND '$endTime'
        ...
        SELECT '61-70.9', COUNT(*)
        FROM line6_data_apb1
        WHERE L6_APB1_TEMP_RIGHT_ACTUAL >= 61 AND L6_APB1_TEMP_RIGHT_ACTUAL < 71
        AND waktu BETWEEN '$startTime' AND '$endTime'
        ...
        SELECT '71-80.9', COUNT(*)
        FROM line6_data_apb1
        WHERE L6_APB1_TEMP_RIGHT_ACTUAL >= 71 AND L6_APB1_TEMP_RIGHT_ACTUAL < 81
        AND waktu BETWEEN '$startTime' AND '$endTime'
        ...
        SELECT '81-90.9', COUNT(*)
        FROM line6_data_apb1
        WHERE L6_APB1_TEMP_RIGHT_ACTUAL >= 81 AND L6_APB1_TEMP_RIGHT_ACTUAL < 91
        AND waktu BETWEEN '$startTime' AND '$endTime'
