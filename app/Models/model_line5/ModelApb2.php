...
class ModelApb2 extends Model
{
    ...
    [
        'L5_APB2_TEMP_LEFT_SETTING',
        'L5_APB2_TEMP_LEFT_ACTUAL',
        'L5_APB2_TEMP_RIGHT_SETTING',
        'L5_APB2_TEMP_RIGHT_ACTUAL',
        'L5_APB2_FIRST_DIPPING_TIME',
        'L5_APB2_WELD_HEAD_DOWN_TIME',
        'L5_APB2_COOLING_TIME',
        'L5_APB2_FLAME_WAITING_TIME',
        'waktu'
    ];
