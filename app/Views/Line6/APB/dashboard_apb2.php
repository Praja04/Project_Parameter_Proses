    ...
    const fetchDataRight1 = () => {
        $.ajax({
            ...
            success: (data) => {
                ...
                updateOrCreateChart(valuesStandardMinimal, valuesStandardMaksimal, 'container', chart, 'APB2 - TEMP RIGHT Actual', labels, valuesSet, 'L6_APB2_TEMP_RIGHT_SETTING', valuesRight, 'L6_APB2_TEMP_RIGHT_ACTUAL', (newChart) => {
                    chart = newChart;
                });
            },
            error: (jqXHR, textStatus, errorThrown) => {
    ...
    const fetchDataLeft1 = () => {
        $.ajax({
            ...
            success: (data) => {
                ...
                updateOrCreateChart(valuesStandardMinimal, valuesStandardMaksimal, 'container2', chart3, 'APB2 - TEMP LEFT Actual', labels, valuesSet, 'L6_APB2_TEMP_LEFT_SETTING', valuesLeft, 'L6_APB2_TEMP_LEFT_ACTUAL', (newChart) => {
                    chart3 = newChart;
                });
            },
            error: (jqXHR, textStatus, errorThrown) => {
