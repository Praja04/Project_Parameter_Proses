    ...
    const fetchDataCell3 = () => {
        $.ajax({
            ...
            success: (data) => {
                ...
                const valuesSet = data.data.map(item => parseFloat(item.L6_APB1_TEMP_LEFT_SETTING)); // Konversi ke angka
                const valuesLeft = data.data.map(item => parseFloat(item.L6_APB1_TEMP_LEFT_ACTUAL)); // Konversi ke angka
                ...
                if (chart3) {
                    ...
                    chart3 = Highcharts.chart('container', {
                        ...
                        title: {
                            text: 'L6_APB1_TEMP_LEFT_SETTING dan L6_APB1_TEMP_LEFT_ACTUAL'
                        },
                        xAxis: {
                            labels: {
                                enabled: false,
                        ...
                        series: [{
                            name: 'L6_APB1_TEMP_LEFT_ACTUAL',
                            data: valuesLeft,
                        }, {
                            name: 'L6_APB1_TEMP_LEFT_SETTING',
                            data: valuesSet,
                        }, {
...
<!-- <script>
    ...
    const fetchDataCell4 = () => {
        $.ajax({
            ...
            success: (data) => {
                const labels = data.data.map(item => item.waktu); // Mengakses waktu
                const valuesRight = data.data.map(item => parseFloat(item.L6_APB1_TEMP_RIGHT_ACTUAL)); // Konversi ke angka
                const valuesSet = data.data.map(item => parseFloat(item.L6_APB1_TEMP_RIGHT_SETTING)); // Konversi ke angka
                ...
                if (chart4) {
                    ...
                    chart4 = Highcharts.chart('container2', {
                        ...
                        title: {
                            text: 'L6_APB1_TEMP_RIGHT_ACTUAL dan L6_APB1_TEMP_RIGHT_SETTING'
                        },
                        xAxis: {
                            labels: {
                                enabled: false,
                        ...
                        series: [{
                            name: 'L6_APB1_TEMP_RIGHT_ACTUAL',
                            data: valuesRight
                        }, {
                            name: 'L6_APB1_TEMP_RIGHT_SETTING',
                            data: valuesSet
                        }, {
    ...
    const fetchDataRight1 = () => {
        $.ajax({
            ...
            success: (data) => {
                ...
                updateOrCreateChart(valuesStandardMinimal, valuesStandardMaksimal, 'container', chart, 'APB1 - TEMP RIGHT Actual', labels, valuesSet, 'L6_APB1_TEMP_RIGHT_SETTING', valuesRight, 'L6_APB1_TEMP_RIGHT_ACTUAL', (newChart) => {
                    chart = newChart;
                });
            },
            error: (jqXHR, textStatus, errorThrown) => {
    ...
    const fetchDataLeft1 = () => {
        $.ajax({
            ...
            success: (data) => {
                ...
                updateOrCreateChart(valuesStandardMinimal, valuesStandardMaksimal, 'container2', chart3, 'apb1 - TEMP LEFT Actual', labels, valuesSet, 'L6_APB1_TEMP_LEFT_SETTING', valuesLeft, 'L6_APB1_TEMP_LEFT_ACTUAL', (newChart) => {
                    chart3 = newChart;
                });
            },
            error: (jqXHR, textStatus, errorThrown) => {
