...
<script>
    ...
    function getdetailngtoday() {
        $.ajax({
            url: '<?= base_url('altline6/get/ng/detail/1') ?>',
            method: 'GET',
            success: function(response) {
                var dataArray = response.data;
                ...
                dataArray.forEach(function(item) {
                    var html = `
                        ...
                        <div class="bg-primary p-15 rounded10 mb-20">
                            ...
                            <h4 class="my-20">Actual Pressure Cell 1 , 3 , 5 : ${item.L6_ALT1_ACTUAL_PRESSURE_CELL1} , ${item.L6_ALT1_ACTUAL_PRESSURE_CELL3} , ${item.L6_ALT1_ACTUAL_PRESSURE_CELL5}</h4> <!-- Replace with the appropriate property -->
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    <h6 class="my-20">Result Cell 1 , 3 , 5 : ${item.L6_ALT1_RESULT_CELL1} , ${item.L6_ALT1_RESULT_CELL3} , ${item.L6_ALT1_RESULT_CELL5}</h6> <!-- Replace with the appropriate property -->
                                </div>
    ...
    $(document).ready(function() {
        ...
        const getdetailngbydate = (date) => {
            $.ajax({
                url: `<?= base_url('altline6/get/ng/detail/1') ?>/${date}`, // Ensure the URL is correct
                method: 'GET',
                success: function(response) {
                    var dataArray = response.data;
                    // Clear previous content
