...
<script>
    ...
    function getdetailngtoday() {
        $.ajax({
            url: '<?= base_url('altline6/get/ng/detail/2') ?>',
            method: 'GET',
            success: function(response) {
                var dataArray = response.data;
                ...
                dataArray.forEach(function(item) {
                    var html = `
                        ...
                        <div class="bg-primary p-15 rounded10 mb-20">
                            ...
                            <h4 class="my-20">Actual Pressure Cell 2 , 4 , 6 : ${item.L6_ALT2_ACTUAL_PRESSURE_CELL2} , ${item.L6_ALT2_ACTUAL_PRESSURE_CELL4} , ${item.L6_ALT2_ACTUAL_PRESSURE_CELL6}</h4> <!-- Replace with the appropriate property -->
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    <h6 class="my-20">Result Cell 2 , 4 , 6 : ${item.L6_ALT2_RESULT_CELL2} , ${item.L6_ALT2_RESULT_CELL4} , ${item.L6_ALT2_RESULT_CELL6}</h6> <!-- Replace with the appropriate property -->
                                </div>
    ...
    $(document).ready(function() {
        ...
        const getdetailngbydate = (date) => {
            $.ajax({
                url: `<?= base_url('altline6/get/ng/detail/2') ?>/${date}`, // Ensure the URL is correct
                method: 'GET',
                success: function(response) {
                    var dataArray = response.data;
                    // Clear previous content
