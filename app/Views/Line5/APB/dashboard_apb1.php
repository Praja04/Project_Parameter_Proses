...
<div class="content-wrapper" style="background-color:rgb(183, 183, 183);">
                ...
                <div class="col-xl-12 col-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Real Time Temperatur APB 1</h4>
                            <div class="row">
...
<!-- <script>
    let chart3;
    const updateInterval3 = 10000; // Interval dalam milidetik
    ...
    const fetchDataCell3 = () => {
        $.ajax({
            ...
            success: (data) => {
                ...
                const valuesSet = data.data.map(item => parseFloat(item.L5_APB1_TEMP_LEFT_SETTING)); // Konversi ke angka
                const valuesLeft = data.data.map(item => parseFloat(item.L5_APB1_TEMP_LEFT_ACTUAL)); // Konversi ke angka
                ...
                if (chart3) {
                    ...
                    chart3 = Highcharts.chart('container', {
                        ...
                        title: {
                            text: 'L5_APB1_TEMP_LEFT_SETTING dan L5_APB1_TEMP_LEFT_ACTUAL'
                        },
                        xAxis: {
                            labels: {
                                enabled: false,
                        ...
                        series: [{
                            name: 'L5_APB1_TEMP_LEFT_ACTUAL',
                            data: valuesLeft,
                        }, {
                            name: 'L5_APB1_TEMP_LEFT_SETTING',
                            data: valuesSet,
                        }, {
...
<!-- <script>
    let chart4;
    const updateInterval4 = 10000; // Interval dalam milidetik
    ...
    const fetchDataCell4 = () => {
        $.ajax({
            ...
            success: (data) => {
                const labels = data.data.map(item => item.waktu); // Mengakses waktu
                const valuesRight = data.data.map(item => parseFloat(item.L5_APB1_TEMP_RIGHT_ACTUAL)); // Konversi ke angka
                const valuesSet = data.data.map(item => parseFloat(item.L5_APB1_TEMP_RIGHT_SETTING)); // Konversi ke angka
                ...
                if (chart4) {
                    ...
                    chart4 = Highcharts.chart('container2', {
                        ...
                        title: {
                            text: 'L5_APB1_TEMP_RIGHT_ACTUAL dan L5_APB1_TEMP_RIGHT_SETTING'
                        },
                        xAxis: {
                            labels: {
                                enabled: false,
                        ...
                        series: [{
                            name: 'L5_APB1_TEMP_RIGHT_ACTUAL',
                            data: valuesRight
                        }, {
                            name: 'L5_APB1_TEMP_RIGHT_SETTING',
                            data: valuesSet
                        }, {
