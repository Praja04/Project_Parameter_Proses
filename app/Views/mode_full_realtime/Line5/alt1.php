...
<script>
    ...
    const fetchDataResultCell1 = () => {
        $.ajax({
            url: '<?= base_url('altline5/get/result/cell1') ?>',
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
                ...
                const labels = data.data.map(item => item.waktu);
                const valuesSet = data.data.map(item => parseFloat(item.L5_ALT1_RESULT_CELL1));

                updateOrCreateChart('container4', chartresult1, 'Result Cell1', labels, valuesSet, 'L5_ALT1_RESULT_CELL1', (newChart) => {
    ...
    const fetchDataResultCell3 = () => {
        $.ajax({
            url: '<?= base_url('altline5/get/result/cell3') ?>',
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
                ...
                const labels = data.data.map(item => item.waktu);
                const valuesSet = data.data.map(item => parseFloat(item.L5_ALT1_RESULT_CELL3));

                updateOrCreateChart('container5', chartresult3, 'Result Cell3', labels, valuesSet, 'L5_ALT1_RESULT_CELL3', (newChart) => {
    ...
    const fetchDataResultCell5 = () => {
        $.ajax({
            url: '<?= base_url('altline5/get/result/cell5') ?>',
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
                ...
                const labels = data.data.map(item => item.waktu);
                const valuesSet = data.data.map(item => parseFloat(item.L5_ALT1_RESULT_CELL5));

                updateOrCreateChart('container6', chartresult5, 'Result Cell5', labels, valuesSet, 'L5_ALT1_RESULT_CELL5', (newChart) => {
    ...
    const fetchDataByDate = (date) => {
        ...
        //fetch result cell 1
        $.ajax({
            url: `<?= base_url('altline5/get/result/cell1/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
        ...
        //fetch result cell 3
        $.ajax({
            url: `<?= base_url('altline5/get/result/cell3/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
        ...
        //fetch result cell 5
        $.ajax({
            url: `<?= base_url('altline5/get/result/cell5/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
    ...
    const fetchDataByWeek = (selectedDate, selectedDate2) => {
        ...
        $.ajax({
            url: `<?= base_url('altline5/data/cell1/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartweek('container', chart, 'Cell1 ', labels, valuesSet, 'L5_ALT1_ACTUAL_PRESSURE_CELL1', (newChart) => {
                    chart = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
        ...
        $.ajax({
            url: `<?= base_url('altline5/data/cell3/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartweek('container2', chart3, 'Cell3', labels, valuesSet, 'L5_ALT1_ACTUAL_PRESSURE_CELL3', (newChart) => {
                    chart3 = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
        ...
        $.ajax({
            url: `<?= base_url('altline5/data/cell5/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartweek('container3', chart5, 'Cell5', labels, valuesSet, 'L5_ALT1_ACTUAL_PRESSURE_CELL5', (newChart) => {
                    chart5 = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
        ...
        //result cell 1 3 5
        $.ajax({
            url: `<?= base_url('altline5/data/result/cell1/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartweek('container4', chartresult1, 'Result Cell1', labels, valuesSet, 'L5_ALT1_RESULT_CELL1', (newChart) => {
                    chartresult1 = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
        ...
        $.ajax({
            url: `<?= base_url('altline5/data/result/cell3/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartweek('container5', chartresult3, 'Result Cell3', labels, valuesSet, 'L5_ALT1_RESULT_CELL3', (newChart) => {
                    chartresult3 = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
        ...
        $.ajax({
            url: `<?= base_url('altline5/data/result/cell5/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartweek('container6', chartresult5, 'Result Cell5', labels, valuesSet, 'L5_ALT1_RESULT_CELL5', (newChart) => {
                    chartresult5 = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
...
<script>
    ...
    $(document).ready(function() {
        ...
        const baseUrl = '<?= base_url('altline5/get/ng/detail/1') ?>';
