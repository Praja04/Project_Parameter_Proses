            ...
            <div class="col-xl-12 col-12" style="background-color:#03346E;">
                <div class="row d-flex flex-row" style="margin: 10px;">
                    ...
                    <div class="col-md-3-5">
                        <div class="box-body" style="background-color:#F2EFE5;">
                            <h5 class="text-center">APB 1 Line 5 Detail</h5>
...
<script>
    ...
    const fetchDataRight1 = () => {
        $.ajax({
            url: '<?= base_url('apbline5/get/temp/right1') ?>',
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                ...
                const valuesSet = data.data.map(item => parseFloat(item.L5_APB1_TEMP_RIGHT_SETTING));
                const valuesRight = data.data.map(item => parseFloat(item.L5_APB1_TEMP_RIGHT_ACTUAL));
                ...
                updateOrCreateChart(valuesStandardMinimal, valuesStandardMaksimal, 'container', chart, 'APB1 - TEMP RIGHT Actual', labels, valuesSet, 'L5_APB1_TEMP_RIGHT_SETTING', valuesRight, 'L5_APB1_TEMP_RIGHT_ACTUAL', (newChart) => {
                    chart = newChart;
    ...
    const fetchDataLeft1 = () => {
        $.ajax({
            url: '<?= base_url('apbline5/get/temp/left1') ?>',
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
                ...
                const labels = data.data.map(item => item.waktu);
                const valuesSet = data.data.map(item => parseFloat(item.L5_APB1_TEMP_LEFT_SETTING));
                const valuesLeft = data.data.map(item => parseFloat(item.L5_APB1_TEMP_LEFT_ACTUAL));
                const valuesStandardMinimal = data.data.map(item => 25); // Konversi ke angka
                const valuesStandardMaksimal = data.data.map(item => 50); // Konversi ke angka

                updateOrCreateChart(valuesStandardMinimal, valuesStandardMaksimal, 'container2', chart3, 'APB1 - TEMP LEFT Actual', labels, valuesSet, 'L5_APB1_TEMP_LEFT_SETTING', valuesLeft, 'L5_APB1_TEMP_LEFT_ACTUAL', (newChart) => {
                    chart3 = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
    ...
    const fetchDataByDate = (date) => {
        // Fetch untuk cell1
        $.ajax({
            url: `<?= base_url('apbline5/get/temp/right1/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
        ...
        // Fetch untuk cell3
        $.ajax({
            url: `<?= base_url('apbline5/get/temp/left1/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
    ...
    const fetchDataByWeek = (selectedDate, selectedDate2) => {
        ...
        $.ajax({
            url: `<?= base_url('apbline5/data/temp/left1/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartweek(valuesStandardMinimal, valuesStandardMaksimal, 'container2', chart3, 'APB1 - TEMP LEFT Actual', labels, valuesSet, 'L5_APB1_TEMP_LEFT_SETTING', valuesLeft, 'L5_APB1_TEMP_LEFT_ACTUAL', (newChart) => {
                    chart3 = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
        ...
        $.ajax({
            url: `<?= base_url('apbline5/data/temp/right1/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartweek(valuesStandardMinimal, valuesStandardMaksimal, 'container', chart, 'APB1 - TEMP RIGHT Actual', labels, valuesSet, 'L5_APB1_TEMP_RIGHT_SETTING', valuesRight, 'L5_APB1_TEMP_RIGHT_ACTUAL', (newChart) => {
                    chart = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
...
<script>
    ...
    const fetchData_tempLeft = () => {
        $.ajax({
            url: '<?= base_url('apbline5/distinct/left1') ?>',
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                createChart('temp_left', '<?= base_url('apbline5/distinct/left1') ?>', 'TEMP_Actual_LEFT_RANGE', 'Temperatur Left');
            },
            error: (jqXHR, textStatus, errorThrown) => {
    ...
    const fetchData_tempRight = () => {
        $.ajax({
            url: '<?= base_url('apbline5/distinct/right1') ?>',
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                createChart('temp_right', '<?= base_url('apbline5/distinct/right1') ?>', 'TEMP_Actual_RIGHT_RANGE', 'Temperatur Right');
            },
            error: (jqXHR, textStatus, errorThrown) => {
                console.error('Error fetching data for temp right apb1:', textStatus, errorThrown);
            }
    ...
    const fetchData_tempByDate = (date) => {
        ...
        $.ajax({
            url: `<?= base_url('apbline5/distinct/right1/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                createChart('temp_right', `<?= base_url('apbline5/distinct/right1/date/') ?>${date}`, 'TEMP_Actual_RIGHT_RANGE', 'Temperatur Right');
            },
            error: (jqXHR, textStatus, errorThrown) => {
                console.error('Error fetching data for temp right apb 1:', textStatus, errorThrown);
            }
        ...
        $.ajax({
            url: `<?= base_url('apbline5/distinct/left1/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                createChart('temp_left', `<?= base_url('apbline5/distinct/left1/date/') ?>${date}`, 'TEMP_Actual_LEFT_RANGE', 'Temperatur Left');
            },
            error: (jqXHR, textStatus, errorThrown) => {
                console.error('Error fetching data for temp left apb 1:', textStatus, errorThrown);
            }
...
<script>
    ...
    function displayData(response) {
        ...
        $('#standar_first_dipping_time').val(response.data['L5_APB1_FIRST_DIPPING_TIME']);
        $('#standar_weld_head_down_time').val(response.data['L5_APB1_WELD_HEAD_DOWN_TIME']);
        $('#standar_flame_waiting_time').val(response.data['L5_APB1_FLAME_WAITING_TIME']);

        $('#actual_temp_right').val(response.data['L5_APB1_TEMP_RIGHT_ACTUAL']);
        $('#actual_temp_left').val(response.data['L5_APB1_TEMP_LEFT_ACTUAL']);
        $('#actual_cooling_time').val(response.data['L5_APB1_COOLING_TIME']);
        $('#actual_first_dipping_time').val(response.data['L5_APB1_FIRST_DIPPING_TIME']);
        $('#actual_weld_head_down_time').val(response.data['L5_APB1_WELD_HEAD_DOWN_TIME']);
        $('#actual_flame_waiting_time').val(response.data['L5_APB1_FLAME_WAITING_TIME']);

    }

    function fetchData() {
        $.ajax({
            url: '<?= base_url('apbline5/get/parameter/1') ?>',
            method: 'GET',
