...
<script>
    ...
    const fetchDataCell2 = () => {
        $.ajax({
            ...
            success: (data) => {
                ...
                const valuesSet = data.data.map(item => parseFloat(item.L6_ALT2_ACTUAL_PRESSURE_CELL2));

                updateOrCreateChart('container', chart, 'Cell2', labels, valuesSet, 'L6_ALT2_ACTUAL_PRESSURE_CELL2', (newChart) => {
                    chart = newChart;
    ...
    const fetchDataCell4 = () => {
        $.ajax({
            ...
            success: (data) => {
                ...
                const filteredLabels = filteredData.map(item => item.waktu.split(' ')[1]); // Jam saja
                const labels = data.data.map(item => item.waktu);
                const valuesSet = data.data.map(item => parseFloat(item.L6_ALT2_ACTUAL_PRESSURE_CELL4));

                updateOrCreateChart('container2', chart3, 'Cell4', labels, valuesSet, 'L6_ALT2_ACTUAL_PRESSURE_CELL4', (newChart) => {
                    chart3 = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
    ...
    const fetchDataCell6 = () => {
        $.ajax({
            url: '<?= base_url('altline6/get/all/cell6') ?>',
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
                ...
                const filteredLabels = filteredData.map(item => item.waktu.split(' ')[1]); // Jam saja
                const labels = data.data.map(item => item.waktu);
                const valuesSet = data.data.map(item => parseFloat(item.L6_ALT2_ACTUAL_PRESSURE_CELL6));

                updateOrCreateChart('container3', chart5, 'Cell6', labels, valuesSet, 'L6_ALT2_ACTUAL_PRESSURE_CELL6', (newChart) => {
                    chart5 = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
    ...
    const fetchDataResultCell2 = () => {
        $.ajax({
            url: '<?= base_url('altline6/get/result/cell2') ?>',
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
                ...
                const labels = data.data.map(item => item.waktu);
                const valuesSet = data.data.map(item => parseFloat(item.L6_ALT2_RESULT_CELL2));

                updateOrCreateChart('container4', chartresult2, 'Result Cell2', labels, valuesSet, 'L6_ALT2_RESULT_CELL2', (newChart) => {
    ...
    const fetchDataResultCell4 = () => {
        $.ajax({
            url: '<?= base_url('altline6/get/result/cell4') ?>',
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
                ...
                const labels = data.data.map(item => item.waktu);
                const valuesSet = data.data.map(item => parseFloat(item.L6_ALT2_RESULT_CELL4));

                updateOrCreateChart('container5', chartresult4, 'Result Cell4', labels, valuesSet, 'L6_ALT1_RESULT_CELL4', (newChart) => {
    ...
    const fetchDataResultCell6 = () => {
        $.ajax({
            url: '<?= base_url('altline6/get/result/cell6') ?>',
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
                ...
                const labels = data.data.map(item => item.waktu);
                const valuesSet = data.data.map(item => parseFloat(item.L6_ALT2_RESULT_CELL6));

                updateOrCreateChart('container6', chartresult6, 'Result Cell6', labels, valuesSet, 'L6_ALT2_RESULT_CELL6', (newChart) => {
    ...
    const fetchDataByDate = (date) => {
        // Fetch untuk cell2
        $.ajax({
            url: `<?= base_url('altline6/get/cell2/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
        ...
        // Fetch untuk cell4
        $.ajax({
            url: `<?= base_url('altline6/get/cell4/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
        ...
        // Fetch untuk cell6
        $.ajax({
            url: `<?= base_url('altline6/get/cell6/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
        ...
        //fetch result cell 2
        $.ajax({
            url: `<?= base_url('altline6/get/result/cell2/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
        ...
        //fetch result cell 4
        $.ajax({
            url: `<?= base_url('altline6/get/result/cell4/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
        ...
        //fetch result cell 6
        $.ajax({
            url: `<?= base_url('altline6/get/result/cell6/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
    ...
    const fetchDataByWeek = (selectedDate, selectedDate2) => {
        ...
        $.ajax({
            url: `<?= base_url('altline6/data/cell2/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartweek('container', chart, 'Cell2 ', labels, valuesSet, 'L6_ALT2_ACTUAL_PRESSURE_CELL2', (newChart) => {
                    chart = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
        ...
        $.ajax({
            url: `<?= base_url('altline6/data/cell4/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartweek('container2', chart3, 'Cell4', labels, valuesSet, 'L6_ALT2_ACTUAL_PRESSURE_CELL4', (newChart) => {
                    chart3 = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
        ...
        $.ajax({
            url: `<?= base_url('altline6/data/cell6/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartweek('container3', chart5, 'Cell6', labels, valuesSet, 'L6_ALT2_ACTUAL_PRESSURE_CELL6', (newChart) => {
                    chart5 = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
        ...
        //result cell
        $.ajax({
            url: `<?= base_url('altline6/data/result/cell2/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartweek('container4', chartresult2, 'Result Cell2', labels, valuesSet, 'L6_ALT2_RESULT_CELL2', (newChart) => {
                    chartresult2 = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
        ...
        $.ajax({
            url: `<?= base_url('altline6/data/result/cell4/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartweek('container5', chartresult4, 'Result Cell4', labels, valuesSet, 'L6_ALT1_RESULT_CELL4', (newChart) => {
                    chartresult4 = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
        ...
        $.ajax({
            url: `<?= base_url('altline6/data/result/cell6/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartweek('container6', chartresult6, 'Result Cell6', labels, valuesSet, 'L6_ALT2_RESULT_CELL6', (newChart) => {
                    chartresult6 = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
...
<script>
    ...
    const fetchDataresultCell2 = () => {
        $.ajax({
            ...
            dataType: 'json',
            success: (data) => {
                createChart('result_cell2', '<?= base_url('altline6/get/distinct/cell2') ?>', 'L6_ALT2_RESULT_CELL2', 'Result Cell 2');
            },
            error: (jqXHR, textStatus, errorThrown) => {
                console.error('Error fetching data for Cell2:', textStatus, errorThrown);
            }
    ...
    const fetchDataresultCell4 = () => {
        $.ajax({
            ...
            dataType: 'json',
            success: (data) => {
                createChart('result_cell4', '<?= base_url('altline6/get/distinct/cell4') ?>', 'L6_ALT2_RESULT_CELL4', 'Result Cell 4');
            },
            error: (jqXHR, textStatus, errorThrown) => {
                console.error('Error fetching data for Cell4:', textStatus, errorThrown);
            }
...
<script>
    ...
    function displayData(response) {
        ...
        $('#standar_fill_pressure').val(response.data['L6_ALT2_FILL_PRESSURE']);
        $('#standar_test_pressure').val(response.data['L6_ALT2_TEST_PRESSURE']);
        $('#standar_fill_failure_time').val(response.data['L6_ALT2_FILL_FAILURE_TIME']);
        $('#standar_stabilization_time').val(response.data['L6_ALT2_STABILIZATION_TIME']);
        $('#standar_test_time').val(response.data['L6_ALT2_TEST_TIME']);
        $('#standar_leak_pressure').val(response.data['L6_ALT2_LEAK_PRESSURE_TOLERANCE']);

        $('#actual_fill_pressure').val(response.data['L6_ALT2_FILL_PRESSURE']);
        $('#actual_test_pressure').val(response.data['L6_ALT2_TEST_PRESSURE']);
        $('#actual_fill_failure_time').val(response.data['L6_ALT2_FILL_FAILURE_TIME']);
        $('#actual_stabilization_time').val(response.data['L6_ALT2_STABILIZATION_TIME']);
        $('#actual_test_time').val(response.data['L6_ALT2_TEST_TIME']);
        $('#actual_leak_pressure').val(response.data['L6_ALT2_LEAK_PRESSURE_TOLERANCE']);
    }

    function fetchData() {
        $.ajax({
            url: '<?= base_url('altline6/get/parameter/2') ?>',
            method: 'GET',
...
<script>
    ...
    $.ajax({
        url: '<?= base_url('altline6/get/total/ok/2') ?>',
        method: 'GET',
        success: function(response) {
    ...
    $.ajax({
        url: '<?= base_url('altline6/get/total/ng/2') ?>',
        method: 'GET',
        success: function(response) {
            var dataArray = response.data;
            const now = new Date();
    ...
    $(document).ready(function() {
        const renderData = (dataArray, containerSelectors) => {
            ...
            dataArray.forEach(item => {
                ...
                <div class="bg-primary p-15 rounded10 mb-20">
                    ...
                    <h4 class="my-20">Actual Pressure Cell 2, 4, 6: ${item.L6_ALT2_ACTUAL_PRESSURE_CELL2}, ${item.L6_ALT2_ACTUAL_PRESSURE_CELL4}, ${item.L6_ALT2_ACTUAL_PRESSURE_CELL6}</h4>
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            <h6 class="my-20">Result Cell 2, 4, 6: ${item.L6_ALT2_RESULT_CELL2}, ${item.L6_ALT2_RESULT_CELL4}, ${item.L6_ALT2_RESULT_CELL6}</h6>
                        </div>
                        <p>${item.waktu}</p>
                    </div>
                </div>
        ...
        const baseUrl = '<?= base_url('altline6/get/ng/detail/2') ?>';
...
<script>
    $(document).ready(function() {
        ...
        calculateMetrics('<?= base_url('altline6/get/distinct/cell2') ?>', '#cp_cell2', '#cpk_cell2', 'L6_ALT2_RESULT_CELL2');

        // Panggil fungsi untuk cell3
        calculateMetrics('<?= base_url('altline6/get/distinct/cell4') ?>', '#cp_cell4', '#cpk_cell4', 'L6_ALT2_RESULT_CELL4');

        // Panggil fungsi untuk cell5
        calculateMetrics('<?= base_url('altline6/get/distinct/cell6') ?>', '#cp_cell6', '#cpk_cell6', 'L6_ALT2_RESULT_CELL6');

        const fetchCPPbyDate = (date) => {
            calculateMetrics(`<?= base_url('altline6/get/distinct/cell2/date/') ?>${date}`, '#cp_cell2', '#cpk_cell2', 'L6_ALT2_RESULT_CELL2');

            // Panggil fungsi untuk cell3
            calculateMetrics(`<?= base_url('altline6/get/distinct/cell4/date/') ?>${date}`, '#cp_cell4', '#cpk_cell4', 'L6_ALT2_RESULT_CELL4');

            // Panggil fungsi untuk cell5
            calculateMetrics(`<?= base_url('altline6/get/distinct/cell6/date/') ?>${date}`, '#cp_cell6', '#cpk_cell6', 'L6_ALT2_RESULT_CELL6');
