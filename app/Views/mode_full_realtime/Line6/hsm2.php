            ...
            <div class="col-xl-12 col-12" style="background-color:#03346E;">
                <div class="row d-flex flex-row" style="margin: 10px;">
                    ...
                    <div class="col-md-1-5">
                        ...
                        <div class="form-group">
                            <input id="jam_now" type="text" class="form-control" disabled>
                    ...
                    <div class="col-md-3-5">
                        <div class="box-body" style="background-color:#C7C8CC; ">
                            <h5 class="text-center">HSM 2 Line 6 Detail</h5>
...
<script>
    ...
    const fetchDataLidHolder = () => {
        $.ajax({
            url: '<?= base_url('hsmline6/get/data/lid_holder_melting/2') ?>',
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                ...
                const valuesActual = data.data.map(item => parseFloat(item.L6_HSM2_LID_HOLDER_ACTUAL_POS));
                const valuesMelting = data.data.map(item => parseFloat(item.L6_HSM2_LID_HOLDER_MELTING_POS));


                // Create upper and lower arrays based on valuesStandar

                updateOrCreateChartMelting('lidholder', chart_lidholder, 'Lid Holder Position', labels, valuesActual, 'L6_HSM2_LID_HOLDER_ACTUAL_POS', valuesMelting, 'L6_HSM2_LID_HOLDER_MELTING_POS', (newChart) => {
    ...
    const fetchDataBoxLifter = () => {
        $.ajax({
            url: '<?= base_url('hsmline6/get/data/box_lifter_melting/2') ?>',
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
                ...
                const labels = data.data.map(item => item.waktu);
                const valuesActual = data.data.map(item => parseFloat(item.L6_HSM2_BOX_LIFTER_ACTUAL_POS));
                const valuesMelting = data.data.map(item => parseFloat(item.L6_HSM2_BOX_LIFTER_MELTING_POS));


                // Create upper and lower arrays based on valuesStandar

                updateOrCreateChartMelting('boxlifter', chart_boxlifter, 'Box Lifter Position', labels, valuesActual, 'L6_HSM2_BOX_LIFTER_ACTUAL_POS', valuesMelting, 'L6_HSM2_BOX_LIFTER_MELTING_POS', (newChart) => {
    ...
    const fetchDataMirrorPos = () => {
        $.ajax({
            url: '<?= base_url('hsmline6/get/data/mirror_pos/2') ?>',
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
                ...
                const labels = data.data.map(item => item.waktu);
                const valuesActual = data.data.map(item => parseFloat(item.L6_HSM2_MIRROR_ACTUAL_POS));
                const valuesMelting = data.data.map(item => parseFloat(item.L6_HSM2_MIRROR_MELTING_POS));


                // Create upper and lower arrays based on valuesStandar

                updateOrCreateChartMelting('mirrorpos', chart_mirror, 'Mirror Position', labels, valuesActual, 'L6_HSM2_MIRROR_ACTUAL_POS', valuesMelting, 'L6_HSM2_MIRROR_MELTING_POS', (newChart) => {
    ...
    const fetchDataByDate = (date) => {
        ...
        $.ajax({
            ...
            success: (data) => {
                ...
                const valuesStandar = data.data.map(item => parseFloat(item.L6_HSM2_TYPE_BATTERY));
        ...
        //lidholder
        $.ajax({
            url: `<?= base_url('hsmline6/get/data/lid_holder_melting2/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
        ...
        //boxlifter
        $.ajax({
            url: `<?= base_url('hsmline6/get/data/box_lifter_melting2/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
        ...
        //mirror pos
        $.ajax({
            url: `<?= base_url('hsmline6/get/data/mirror_pos2/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
    ...
    const fetchDataByWeek = (selectedDate, selectedDate2) => {
        ...
        $.ajax({
            url: `<?= base_url('hsmline6/data/temp/right2/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                const upper = valuesStandar.map(value => (value === 0 || value === 2) ? 435 : 425);
                const lower = valuesStandar.map(value => (value === 0 || value === 2) ? 415 : 405);
                updateOrCreateChartweek('container', chart, 'TEMP RIGHT', labels, valuesSet, 'L6_HSM2_TEMP_SET_VALUE', valuesRight, 'L6_HSM2_TEMP_RIGHT', (newChart) => {
                    chart = newChart;
                }, upper, lower, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
        ...
        $.ajax({
            url: `<?= base_url('hsmline6/data/temp/left2/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                const upper = valuesStandar.map(value => (value === 0 || value === 2) ? 435 : 425);
                const lower = valuesStandar.map(value => (value === 0 || value === 2) ? 415 : 405);
                updateOrCreateChartweek('container2', chart, 'TEMP LEFT', labels, valuesSet, 'L6_HSM2_TEMP_SET_VALUE', valuesLeft, 'L6_HSM2_TEMP_LEFT', (newChart) => {
                    chart = newChart;
                }, upper, lower, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
        ...
        $.ajax({
            url: `<?= base_url('hsmline6/data/lid_holder2/pos/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartMeltingweek('lidholder', chart_lidholder, 'Lid Holder Position', labels, valuesActual, 'L6_HSM2_LID_HOLDER_ACTUAL_POS', valuesMelting, 'L6_HSM2_LID_HOLDER_MELTING_POS', (newChart) => {
                    chart_lidholder = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
        ...
        $.ajax({
            url: `<?= base_url('hsmline6/data/box_lifter2/pos/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartMeltingweek('boxlifter', chart_boxlifter, 'Box Lifter Position', labels, valuesActual, 'L6_HSM2_BOX_LIFTER_ACTUAL_POS', valuesMelting, 'L6_HSM2_BOX_LIFTER_MELTING_POS', (newChart) => {
                        chart_boxlifter = newChart;
                    },
                    filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
        ...
        $.ajax({
            url: `<?= base_url('hsmline6/data/mirror2/pos/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartMeltingweek('mirrorpos', chart_mirror, 'Mirror Position', labels, valuesActual, 'L6_HSM2_MIRROR_ACTUAL_POS', valuesMelting, 'L6_HSM2_MIRROR_MELTING_POS', (newChart) => {
                    chart_mirror = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
...
<script>
    ...
    const fetchData_tempLeft = () => {
        $.ajax({
            url: '<?= base_url('hsmline6/distinct/left2') ?>',
            method: 'GET',
            dataType: 'json',
            success: (data) => {
    ...
    const fetchData_tempRight = () => {
        $.ajax({
            url: '<?= base_url('hsmline6/distinct/right2') ?>',
            method: 'GET',
            dataType: 'json',
            success: (data) => {
    ...
    const fetchData_tempByDate = (date) => {
        ...
        $.ajax({
            url: `<?= base_url('hsmline6/distinct/right2/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                createChart('temp_right', `<?= base_url('hsmline6/distinct/right2/date/') ?>${date}`, 'TEMP_RIGHT_RANGE', 'Temperatur Right');
            },
            error: (jqXHR, textStatus, errorThrown) => {
                console.error('Error fetching data for temp right hsm 2:', textStatus, errorThrown);
            }
        ...
        $.ajax({
            url: `<?= base_url('hsmline6/distinct/left2/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                createChart('temp_left', `<?= base_url('hsmline6/distinct/left2/date/') ?>${date}`, 'TEMP_LEFT_RANGE', 'Temperatur Left');
            },
            error: (jqXHR, textStatus, errorThrown) => {
...
<script>
    ...
    $.ajax({
        url: '<?= base_url('hsmline6/get/data/ok/2') ?>',
        method: 'GET',
        success: function(response) {
...
<script>
    ...
    function displayData(response) {
        ...
        if (response.data['L6_HSM2_TYPE_BATTERY'] == '2' || response.data['L6_HSM2_TYPE_BATTERY'] == '0') {
        ...
        } else if (response.data['L6_HSM2_TYPE_BATTERY'] == '1') {
        ...
        $('#temp_left1').val(response.data['L6_HSM2_TEMP_LEFT']);
        $('#temp_right1').val(response.data['L6_HSM2_TEMP_RIGHT']);
        $('#set_value1').val(response.data['L6_HSM2_TEMP_SET_VALUE']);
        $('#set_value2').val(response.data['L6_HSM2_TEMP_SET_VALUE']);
        $('#standar_lid_holder_melting_pos').val(response.data['L6_HSM2_LID_HOLDER_MELTING_POS']);
        $('#actual_lid_holder_melting_pos').val(response.data['L6_HSM2_LID_HOLDER_MELTING_POS']);
        $('#actual_lid_holder_sealing_pos').val(response.data['L6_HSM2_LID_HOLDER_SEALING_POS']);
        $('#standar_lid_holder_sealing_pos').val(response.data['L6_HSM2_LID_HOLDER_SEALING_POS']);
        $('#standar_box_lifter_melting_pos').val(response.data['L6_HSM2_BOX_LIFTER_MELTING_POS']);
        $('#actual_box_lifter_melting_pos').val(response.data['L6_HSM2_BOX_LIFTER_MELTING_POS']);
        $('#standar_box_lifter_sealing_pos').val(response.data['L6_HSM2_BOX_LIFTER_SEALING_POS']);
        $('#actual_box_lifter_sealing_pos').val(response.data['L6_HSM2_BOX_LIFTER_SEALING_POS']);
        $('#standar_mirror_melting_pos').val(response.data['L6_HSM2_MIRROR_MELTING_POS']);
        $('#actual_mirror_melting_pos').val(response.data['L6_HSM2_MIRROR_MELTING_POS']);
        $('#actual_lid_melting_time').val(response.data['L6_HSM2_LID_MELTING_TIME']);
        $('#actual_box_melting_time').val(response.data['L6_HSM2_BOX_MELTING_TIME']);
        $('#actual_sealing_time').val(response.data['L6_HSM2_SEALING_TIME']);
    }

    function fetchData() {
        $.ajax({
            url: '<?= base_url('hsmline6/get/data/parameter/2') ?>',
            method: 'GET',
            success: function(response) {
                //(response)
                clearInterval(intervalId); // Hentikan animasi angka acak
                displayData(response); // Tampilkan data
                setTimeout(startRandomAnimation, 100000); // Mulai animasi angka acak setelah 10 detik
            },
            error: function(error) {
                console.error('Ada masalah dengan pengambilan data:', error);
            }
