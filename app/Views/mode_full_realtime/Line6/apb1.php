...
<script>
    ...
    const fetchDataRight1 = () => {
        $.ajax({
            url: '<?= base_url('apbline6/get/temp/right1') ?>',
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                ...
                const valuesSet = data.data.map(item => parseFloat(item.L6_APB1_TEMP_RIGHT_SETTING));
                const valuesRight = data.data.map(item => parseFloat(item.L6_APB1_TEMP_RIGHT_ACTUAL));
                ...
                updateOrCreateChart2(valuesStandardMinimal, valuesStandardMaksimal, 'container', chart, 'APB1 - TEMP RIGHT Actual', labels, valuesSet, 'L6_APB1_TEMP_RIGHT_SETTING', valuesRight, 'L6_APB1_TEMP_RIGHT_ACTUAL', (newChart) => {
                    chart = newChart;
    ...
    const fetchDataLeft1 = () => {
        $.ajax({
            url: '<?= base_url('apbline6/get/temp/left1') ?>',
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
                ...
                const labels = data.data.map(item => item.waktu);
                const valuesSet = data.data.map(item => parseFloat(item.L6_APB1_TEMP_LEFT_SETTING));
                const valuesLeft = data.data.map(item => parseFloat(item.L6_APB1_TEMP_LEFT_ACTUAL));
                const valuesStandardMinimal = data.data.map(item => 25); // Konversi ke angka
                const valuesStandardMaksimal = data.data.map(item => 50); // Konversi ke angka

                updateOrCreateChart2(valuesStandardMinimal, valuesStandardMaksimal, 'container2', chart3, 'APB1 - TEMP LEFT Actual', labels, valuesSet, 'L6_APB1_TEMP_LEFT_SETTING', valuesLeft, 'L6_APB1_TEMP_LEFT_ACTUAL', (newChart) => {
                    chart3 = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
    ...
    const fetchDataByDate = (date) => {
        // Fetch untuk cell1
        $.ajax({
            url: `<?= base_url('apbline6/get/temp/right1/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
        ...
        // Fetch untuk cell3
        $.ajax({
            url: `<?= base_url('apbline6/get/temp/left1/date/') ?>${date}`,
            method: 'GET',
            dataType: 'json',
            success: (data) => {
                const time = data.data.map(item => item.waktu);
    ...
    const fetchDataByWeek = (selectedDate, selectedDate2) => {
        ...
        $.ajax({
            url: `<?= base_url('apbline6/data/temp/left1/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartweek(valuesStandardMinimal, valuesStandardMaksimal, 'container2', chart3, 'APB1 - TEMP LEFT Actual', labels, valuesSet, 'L6_APB1_TEMP_LEFT_SETTING', valuesLeft, 'L6_APB1_TEMP_LEFT_ACTUAL', (newChart) => {
                    chart3 = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
        ...
        $.ajax({
            url: `<?= base_url('apbline6/data/temp/right1/week') ?>`,
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                updateOrCreateChartweek(valuesStandardMinimal, valuesStandardMaksimal, 'container', chart, 'APB1 - TEMP RIGHT Actual', labels, valuesSet, 'L6_APB1_TEMP_RIGHT_SETTING', valuesRight, 'L6_APB1_TEMP_RIGHT_ACTUAL', (newChart) => {
                    chart = newChart;
                }, filteredLabels, data.data.map(item => item.waktu.split(' ')[1]));
            },
            error: (jqXHR, textStatus, errorThrown) => {
...
<script>
    ...
    function displayData(response) {
        ...
        $('#standar_first_dipping_time').val(response.data['L6_APB1_FIRST_DIPPING_TIME']);
        $('#standar_weld_head_down_time').val(response.data['L6_APB1_WELD_HEAD_DOWN_TIME']);
        $('#standar_flame_waiting_time').val(response.data['L6_APB1_FLAME_WAITING_TIME']);

        $('#actual_temp_right').val(response.data['L6_APB1_TEMP_RIGHT_ACTUAL']);
        $('#actual_temp_left').val(response.data['L6_APB1_TEMP_LEFT_ACTUAL']);
        $('#actual_cooling_time').val(response.data['L6_APB1_COOLING_TIME']);
        $('#actual_first_dipping_time').val(response.data['L6_APB1_FIRST_DIPPING_TIME']);
        $('#actual_weld_head_down_time').val(response.data['L6_APB1_WELD_HEAD_DOWN_TIME']);
        $('#actual_flame_waiting_time').val(response.data['L6_APB1_FLAME_WAITING_TIME']);

    }

    function fetchData() {
        $.ajax({
            url: '<?= base_url('apbline6/get/parameter/1') ?>',
            method: 'GET',
