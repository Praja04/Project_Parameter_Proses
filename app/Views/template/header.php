		...
		<div class="app-menu">
			<ul class="header-megamenu nav">
				...
				<li class="btn-group nav-item d-none d-xl-inline-block">
					<a href="<?= base_url('/') ?>" class="waves-effect waves-light nav-link svg-bt-icon" title="Menu">
						<i class="ti ti-layout-accordion-list"><span class="path1"></span><span class="path2"></span>
						</i>
						<h5 class="p-15">Menu</h5>
					</a>
				</li>
				<li class="btn-group nav-item d-none d-xl-inline-block text-center">
					<a href="<?= base_url('/') ?>">
						<h5 class="p-15">Menu</h5>
					</a>
				</li>
				<li class="btn-group nav-item d-none d-xl-inline-block">
					<a href="<?= base_url('mode/line6/hsm1') ?>" class="waves-effect waves-light nav-link svg-bt-icon" title="Menu">
						<i class="ti ti-dashboard"><span class="path1"></span><span class="path2"></span>
						</i>
						<h5 class="p-15">Menu</h5>
					</a>
				</li>
